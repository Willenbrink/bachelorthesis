...
A term in first-order logic, chosen from the infinite set $\T \coloneqq \{t, u, v, t_{1}, t_{2}, ...\}$, is a symbol $s$ applied to $\arity(s)$ arguments, where each argument again is a term.
